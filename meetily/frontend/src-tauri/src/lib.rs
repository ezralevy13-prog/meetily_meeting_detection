...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            meeting_detector::commands::get_calendar_access_status,
            meeting_detector::commands::request_calendar_access,
            meeting_detector::commands::list_calendars,
            ...
            // Summary commands
            summary::chat::api_chat_with_meeting,
            summary::chat::api_chat_with_live_transcript,
